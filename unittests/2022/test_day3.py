...
def lists_with_shared_element(draw):
    ...
    set_generator = st.sets(random_integer, min_size=size, max_size=size)
...
class TestDay3:
    ...
    def test_get_shared_element(self, lists_with_shared_element):
        # Prepare
        left_list, _, right_list, expected_value = lists_with_shared_element

        # Run
        common_element = day3.get_shared_element(left_list, right_list)

        # Assert
        assert common_element == expected_value
    ...
    def test_get_triplet_shared_element(self, lists_with_shared_element):
        ...
        ) = lists_with_shared_element

        # Run
        common_element = day3.get_triplet_shared_element(
